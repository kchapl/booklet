...
import booklet.service.bookfinder.GoogleBookModel.GoogleBookResult.toBook
import booklet.service.bookfinder.GoogleBookModel.{EmptyGoogleBookResult, GoogleBookResult}
