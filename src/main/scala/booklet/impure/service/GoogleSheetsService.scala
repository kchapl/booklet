...
object GoogleSheetsService {
  ...
  def updateBook(userId: String, id: BookId, data: BookData): ZIO[GoogleSheetsService, Failure, Unit] =
  ...
  def updateReading(userId: String, id: ReadingId, data: ReadingData): ZIO[GoogleSheetsService, Failure, Unit] =
...
object GoogleSheetsServiceLive {
  val layer: ZLayer[Any, Nothing, GoogleSheetsService] = ZLayer.succeed(new GoogleSheetsService {
    ...
    override def updateReading(userId: String, id: ReadingId, data: ReadingData): IO[Failure, Unit] = {
